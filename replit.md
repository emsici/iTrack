...
COMPLETE THEME SYSTEM FIX 19-08-2025: Rezolvată aplicarea temelor peste tot în aplicație - CourseDetailCard adaptată pentru toate temele (dark, light, business, driver, nature, night) cu background și border specifice, SettingsModal cu închidere automată la schimbarea temei, VehicleNumberDropdown îmbunătățit pentru formularul de adăugare vehicul, text colors adaptate pentru fiecare temă individual. Tema se aplică consistent în toate componentele.
