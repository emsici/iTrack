...
class AppLoggerService {
  ...
  private readonly MAX_LOGS = 1000; // Maximum logs to store
  private logs: AppLog[] = [];
  ...
  log(level: 'INFO' | 'WARN' | 'ERROR' | 'DEBUG', message: string, category: string = 'APP'): void {
...
export const logOfflineSync = (message: string) => appLogger.logOfflineSync(message);
